...
import { 
  ...
  FaBed, FaCalendarAlt, FaCreditCard, FaStar, FaArrowRight, FaHandshake, 
  FaCheckCircle, FaGlobe, FaCogs, FaUsers, FaChartLine, FaShieldAlt
} from 'react-icons/fa';
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <motion.section 
        ...
        className="py-8 sm:py-12 md:py-16 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 relative overflow-hidden"
      >
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div
              variants={fadeInUp}
              className="inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-blue-100 to-indigo-100 rounded-full mb-4"
            >
              <FaCreditCard className="w-3 h-3 text-blue-600 mr-2" />
              <span className="text-xs sm:text-sm font-semibold text-gray-700">Flexible Credit • Personal Loans • Financial Freedom</span>
              <FaHandshake className="w-3 h-3 text-indigo-600 ml-2" />
            </motion.div>

            <motion.h1
              variants={fadeInUp}
              className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-gray-800 via-blue-700 to-indigo-700 bg-clip-text text-transparent mb-4 leading-tight"
            >
            ...
            >
              Your trusted partner for flexible credit solutions and personal loans, empowering individuals and businesses with financial freedom and confidence.
            </motion.p>
          </motion.div>
        </div>
      </motion.section>
          ...
          >
            <motion.div variants={fadeInLeft}>
              ...
              <p className="text-sm sm:text-base md:text-lg text-gray-600 leading-relaxed mb-4">
                We understand that financial needs vary from person to person and business to business. That's why we offer flexible credit solutions designed to meet your unique requirements, whether you're an individual looking for personal loans or a business seeking expansion capital.
              </p>
              ...
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                {[
                  { icon: FaCreditCard, label: "Flexible Credit", color: "text-blue-600" },
                  { icon: FaChartLine, label: "Personal Loans", color: "text-indigo-600" },
                  { icon: FaShieldAlt, label: "Financial Freedom", color: "text-purple-600" },
                  { icon: FaUsers, label: "Business Support", color: "text-green-600" }
                ].map((item, index) => (
                  <motion.div 
                    key={index}
            ...
            >
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-indigo-500 rounded-2xl blur-xl opacity-15 group-hover:opacity-25 transition-opacity duration-300"></div>
                <img
                  src="/images/akr-easy-credit.jpg"
                  alt="AKR Easy Credit"
            ...
            {[
              {
                ...
                description: "Flexible personal loans with competitive rates",
              ...
              },
              {
                ...
                description: "Credit solutions for business expansion",
              ...
              >
                ...
                <h3 className={`text-base sm:text-lg font-bold ${feature.gradient.includes('blue') ? 'text-blue-800' : feature.gradient.includes('indigo') ? 'text-indigo-800' : 'text-purple-800'} mb-2`}>
                  {feature.title}
                </h3>
                <p className={`text-xs sm:text-sm ${feature.gradient.includes('blue') ? 'text-blue-700' : feature.gradient.includes('indigo') ? 'text-indigo-700' : 'text-purple-700'} leading-relaxed`}>
                  {feature.description}
                </p>
              </motion.div>
            ))}
          ...
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-4 sm:p-6 lg:p-8 mb-8">
            ...
            >
              ...
              <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-2xl mx-auto">
                Comprehensive credit solutions and financial services for individuals and businesses
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  features: ["Quick approval", "Flexible terms", "Competitive rates", "Easy application"]
                },
                {
                  icon: "🏢",
                  title: "Business Credit",
                  description: "Credit solutions for business expansion and development",
                  features: ["Business loans", "Working capital", "Equipment financing", "Growth funding"]
                },
                {
                  icon: "⚡",
                  title: "Quick Approval",
                ...
                >
                  <div className="flex items-start space-x-3 sm:space-x-4 mb-3">
                    <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-xl flex items-center justify-center flex-shrink-0 shadow-md">
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-2xl p-4 sm:p-6 lg:p-8">
            ...
            >
              <motion.div variants={fadeInLeft}>
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent mb-4 sm:mb-6">Contact AKR Easy Credit</h3>
                <div className="space-y-3 sm:space-y-4">
                  {[
                    { icon: FaClock, title: "Business Hours", info: "Mon - Sat: 9:00 AM - 6:00 PM", subtitle: "Sunday: 10:00 AM - 4:00 PM" },
                    { icon: FaMapMarkerAlt, title: "Location", info: "Main Street, Murunkan", subtitle: "Mannar - Financial services center" },
                    { icon: FaPhoneAlt, title: "Get Credit", info: "Phone: 0773111266", subtitle: "Call for credit solutions and loan inquiries" }
                  ].map((item, index) => (
                    <motion.div 
                      key={index}
              ...
              <motion.div variants={fadeInRight}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  {[
                    ...
                    { icon: "🤝", title: "Trusted Partner", description: "Reliable financial services" }
                  ].map((benefit, index) => (
                    <motion.div 
                      key={index}
