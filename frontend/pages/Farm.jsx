...
import { 
  ...
  FaBed, FaCalendarAlt, FaLeaf, FaStar, FaArrowRight, FaSeedling, 
  FaCheckCircle, FaGlobe, FaCogs, FaUsers, FaHeart, FaTractor, FaAppleAlt
} from 'react-icons/fa';
  ...
  return (
    <div className="min-h-screen bg-white">
            ...
            >
              ...
              <div>
                ...
                <div className="text-xs text-gray-500 font-medium">
                  Sustainable Agriculture & Fresh Produce
                </div>
              </div>
            </motion.div>
      ...
      <motion.section 
        ...
        className="py-8 sm:py-12 md:py-16 bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 relative overflow-hidden"
      >
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          />
          <motion.div
            className="absolute top-0 right-10 w-48 h-48 md:w-64 md:h-64 bg-emerald-200 rounded-full mix-blend-multiply filter blur-xl opacity-20"
            animate={{ 
              x: [0, -30, 0],
              y: [0, 30, 0],
            }}
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div
              variants={fadeInUp}
              className="inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-green-100 to-emerald-100 rounded-full mb-4"
            >
              <FaSeedling className="w-3 h-3 text-green-600 mr-2" />
              <span className="text-xs sm:text-sm font-semibold text-gray-700">Sustainable Farming • Organic Produce • Farm-to-Table</span>
              <FaLeaf className="w-3 h-3 text-emerald-600 ml-2" />
            </motion.div>

            <motion.h1
              variants={fadeInUp}
              className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-gray-800 via-green-700 to-emerald-700 bg-clip-text text-transparent mb-4 leading-tight"
            >
              🌱 AKR Farm 🌾
            </motion.h1>
            ...
            >
              A forward-thinking agricultural initiative promoting sustainable, organic farming practices to provide fresh, healthy produce from our fields to your table.
            </motion.p>
          </motion.div>
        </div>
      </motion.section>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div variants={fadeInLeft}>
              <div className="inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-green-100 to-emerald-100 rounded-full mb-4">
                <FaCheckCircle className="w-3 h-3 text-green-600 mr-2" />
                <span className="text-xs sm:text-sm font-semibold text-gray-700">Sustainable Agriculture & Organic Farming</span>
              </div>
              
              <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 leading-tight">
                From Our Fields to 
                <span className="bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent"> Your Table</span>
              </h2>
              
              <p className="text-sm sm:text-base md:text-lg text-gray-600 leading-relaxed mb-4">
                We are committed to sustainable, organic farming practices that prioritize environmental conservation while producing the highest quality fresh produce. Our forward-thinking approach combines traditional wisdom with modern agricultural techniques.
              </p>
              
              <p className="text-sm sm:text-base md:text-lg text-gray-600 leading-relaxed mb-6">
                From seed to harvest, we ensure every step of our farming process promotes soil health, biodiversity, and produces nutritious, chemical-free food that nourishes both people and the planet.
              </p>
              
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                {[
                  { icon: FaSeedling, label: "Organic Farming", color: "text-green-600" },
                  { icon: FaLeaf, label: "Sustainable", color: "text-emerald-600" },
                  { icon: FaAppleAlt, label: "Fresh Produce", color: "text-red-600" },
                  { icon: FaUsers, label: "Community", color: "text-blue-600" }
                ].map((item, index) => (
                  <motion.div 
                    key={index}
            ...
            >
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-r from-green-400 to-emerald-500 rounded-2xl blur-xl opacity-15 group-hover:opacity-25 transition-opacity duration-300"></div>
                <img
                  src="/images/akr-farm.jpg"
                  alt="AKR Farm"
            ...
            {[
              {
                ...
                description: "Chemical-free farming practices for healthy produce",
              ...
              },
              {
                icon: "🌾",
                title: "Fresh Produce",
                description: "Fresh vegetables and fruits from our fields",
              ...
              >
                ...
                <h3 className={`text-base sm:text-lg font-bold ${feature.gradient.includes('green') ? 'text-green-800' : feature.gradient.includes('emerald') ? 'text-emerald-800' : 'text-teal-800'} mb-2`}>
                  {feature.title}
                </h3>
                <p className={`text-xs sm:text-sm ${feature.gradient.includes('green') ? 'text-green-700' : feature.gradient.includes('emerald') ? 'text-emerald-700' : 'text-teal-700'} leading-relaxed`}>
                  {feature.description}
                </p>
              </motion.div>
            ))}
          ...
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-4 sm:p-6 lg:p-8 mb-8">
            ...
            >
              ...
              <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-2xl mx-auto">
                Fresh, organic produce and sustainable farming solutions for healthy living
              </p>
            </motion.div>
              ...
              {[
                {
                  ...
                  features: ["Leafy greens", "Root vegetables", "Seasonal produce", "Chemical-free"]
                },
                {
                  icon: "🍎",
                  title: "Fresh Fruits",
                  description: "Nutritious fruits from our organic orchards",
                  features: ["Seasonal fruits", "Tree fruits", "Berry varieties", "Fresh harvest"]
                },
                {
                  icon: "🌾",
                  title: "Grains & Cereals",
                  description: "Whole grains and cereals for healthy nutrition",
                  features: ["Rice varieties", "Wheat products", "Millets", "Organic grains"]
                },
                {
                  icon: "🥛",
                  title: "Dairy Products",
                  description: "Fresh dairy products from our farm animals",
                  features: ["Fresh milk", "Dairy products", "Farm eggs", "Natural products"]
                }
              ].map((service, index) => (
                <motion.div
                  key={index}
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 border border-gray-200 rounded-2xl p-4 sm:p-6 lg:p-8">
            ...
            >
              <motion.div variants={fadeInLeft}>
                <h3 className="text-lg sm:text-xl md:text-2xl font-bold bg-gradient-to-r from-gray-800 to-gray-600 bg-clip-text text-transparent mb-4 sm:mb-6">Contact AKR Farm</h3>
                <div className="space-y-3 sm:space-y-4">
                  {[
                    { icon: FaClock, title: "Farm Hours", info: "Mon - Sat: 6:00 AM - 6:00 PM", subtitle: "Sunday: 7:00 AM - 5:00 PM" },
                    { icon: FaMapMarkerAlt, title: "Farm Location", info: "Main Street, Murunkan", subtitle: "Mannar - Fresh produce destination" },
                    { icon: FaPhoneAlt, title: "Get Fresh Produce", info: "Phone: 0773111266", subtitle: "Call for fresh farm products and orders" }
                  ].map((item, index) => (
                    <motion.div 
                      key={index}
              ...
              <motion.div variants={fadeInRight}>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                  {[
                    { icon: "🌱", title: "Organic", description: "Chemical-free farming" },
                    { icon: "🌍", title: "Sustainable", description: "Eco-friendly practices" },
                    { icon: "🥬", title: "Fresh Produce", description: "Farm-to-table" },
                    { icon: "💚", title: "Healthy", description: "Nutritious food" }
                  ].map((benefit, index) => (
                    <motion.div 
                      key={index}
